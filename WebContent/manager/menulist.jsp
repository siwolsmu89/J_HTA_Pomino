									...
									<div class="col-6">
										<div class="dropdown">
											<button type="button" class="btn btn-light dropdown-toggle"
												data-toggle="dropdown">- 메뉴 선택 -</button>
							...
							<table id="pizza-menu" class="table text-center">
								...
								<thead class="thead-dark">
									<tr>
										...
										<th>이벤트</th>
										<th colspan='2'>
											<a class="btn btn-light" href="pizzaform.jsp">신규 피자 등록</a>
										</th>
								...
								<tbody>
									<tr>
										...
										<td>여름방학시즌</td>
										<td>
											<a class="btn btn-primary text-light" href="pizzamodifyform.jsp">수정</a>
										</td>
										<td>
											<a class="btn btn-danger text-light">비활성</a>
										</td>
									</tr>
									<tr>
										<td>2</td>
							...
							<table id="side-menu" class="table text-center">
								...
								<thead class="thead-dark">
									<tr>
										...
										<th>단종여부</th>
										<th colspan='2'>
											<a class="btn btn-light" href="sidemenuform.jsp">신규 사이드 등록</a>
										</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										...
										<td>N</td>
										<td>
											<a class="btn btn-primary text-light" href="sidemenumodifyform.jsp">수정</a>
										</td>
										<td>
											<a class="btn btn-danger text-light">비활성</a>
										</td>
							...
							<table id="doughs-menu" class="table text-center">
								...
								<thead class="thead-dark">
									<tr>
										...
										<th>단종여부</th>
										<th colspan='2'>
											<a class="btn btn-light" href="doughform.jsp">신규 도우 등록</a>
										</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										...
										<td>N</td>
										<td>
											<a class="btn btn-primary text-light" href="doughmodifyform.jsp">수정</a>
										</td>
										<td>
											<a class="btn btn-danger text-light">비활성</a>
										</td>
							...
							<table id="topping-menu" class="table text-center">
								...
								<thead class="thead-dark">
									<tr>
										...
										<th>단종여부</th>
										<th colspan='2'>
											<a class="btn btn-light" href="toppingform.jsp">신규 토핑 등록</a>
										</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										...
										<td>N</td>
										<td>
											<a class="btn btn-primary text-light" href="toppingmodifyform.jsp">수정</a>
										</td>
										<td>
											<a class="btn btn-danger text-light">비활성</a>
										</td>
							...
							<table id="etc-menu" class="table text-center">
								...
								<thead class="thead-dark">
									<tr>
										...
										<th>단종여부</th>
										<th colspan='2'>
											<a class="btn btn-light" href="etcmenuform.jsp">신규 기타 메뉴 등록</a>
										</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										...
										<td>N</td>
										<td>
											<a class="btn btn-primary text-light" href="etcmenumodifyform.jsp">수정</a>
										</td>
										<td>
											<a class="btn btn-danger text-light">비활성</a>
										</td>
