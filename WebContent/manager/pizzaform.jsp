					...
					<div class="card-body">
						...
						<form method="post" action="pizza.jsp">				
							<div class="form-group">
								<label>피자이름</label>
								<input type="text" class="form-control" name="name" placeholder="예)불고기피자"/>
							</div>
							<div class="form-group">
								<label>L가격</label>
								<input type="text" class="form-control" name="lprice" placeholder="23000"/>
							</div>
							<div class="form-group">
								<label>M가격</label>
								<input type="text" class="form-control" name="mprice" placeholder="17500"/>
							</div>
							<!-- 사진등록 -->
			                <div class="form-group">
			                    <label>첨부파일</label>
